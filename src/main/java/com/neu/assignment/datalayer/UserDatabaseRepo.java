...
public interface UserDatabaseRepo {
    ...
    User getUser(String user_name) throws WebappExceptions;
    void updateUser(String first_name, String last_name, String password, String user_name) throws WebappExceptions;
